...
if "76561199651437991" != jBlacklist.Owner then return end
...
if SERVER then
	...
	concommand.Add("jblacklist_license",function( ply )
		...
		jBlacklist.Notify(JBLACKLIST_NOTIFYENUM_CHAT, "[  O: 76561199651437991 | " .. jBlacklist.Owner, ply)
		jBlacklist.Notify(JBLACKLIST_NOTIFYENUM_CHAT, "[  R: " .. tostring(jBlacklist.Owner == "76561199651437991"), ply)
		jBlacklist.Notify(JBLACKLIST_NOTIFYENUM_CHAT, "|_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_|", ply)
